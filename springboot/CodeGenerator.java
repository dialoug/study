...
public class CodeGenerator {
	...
	// 数据库名称
	private static final String DATASOURCE = "hospital";
	
	// 你自己的项目路径，一定要改成你自己的！！结尾必须是:  \\springboot\\
	//private static final String basePath = "D:\\code\\JAVA\\SpringBoot+VUE\\医院在线挂号系统\\springboot\\";
	private static final String basePath = "C:\\Users\\Dicloug\\Desktop\\springboot\\springboot\\";

	// 数据库需要生成代码的表名
	private static final String tableName = "t_scheduling";
	// 生成页面的菜单名称
	private static final String modelName = "排班管理";
	...
	private static void createVue(String tableName) throws Exception {
		...
		for (TableColumn tableColumn : tableColumns) {
			...
			if (tableColumn.getName().contains("time")) {
				...
				// 文件上传
				formBuilder.append(space10).append("<el-upload action=\"http://localhost:9000/file/upload\" ref=\"file\" :on-success=\"handleFileUploadSuccess\">\n");
				...
				// 文件上传
				formBuilder.append(space10).append("<el-upload action=\"http://localhost:9000/file/upload\" ref=\"img\" :on-success=\"handleImgUploadSuccess\">\n");
				formBuilder.append(space10).append("  <el-button size=\"small\" type=\"primary\">点击上传</el-button>\n");
				formBuilder.append(space10).append("</el-upload>\n");
			} else {
...
//        String createSql = StrUtil.format("INSERT INTO `t_menu` (`name`, `path`, `icon`, `page_path`, `sort_num`) VALUES ('{}', '{}', '{}', '{}', {})",
//                modelName, "/" + lowerEntityName, "el-icon-menu", upperEntityName, 999);
		String createSql = StrUtil.format("INSERT INTO `sys_menu` (`name`, `path`, `icon`, `description`, `page_path`,`sort_num`) VALUES ('{}', '{}', '{}', '{}', '{}', {})",
				modelName, "/" + lowerEntityName, "el-icon-menu", upperEntityName, "admin/" + upperEntityName, 999);
